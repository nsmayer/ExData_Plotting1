...
par(mfrow=c(2, 2))
plot(date, df$Global_active_power, type = "l", ylab = "Global Active Power", xlab="")
plot(date, df$Voltage, type = "l", ylab = "Global Active Power", xlab="datetime")
...
legend(x = 1170380080 , y = 39.5, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = c(1, 1, 1), col = c("black","red", "blue"), cex = 0.85, bty = "n")

plot(date, df$Global_reactive_power, type = "l", ylab = "Global Active Power", xlab="datetime")
